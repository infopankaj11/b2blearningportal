<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CMS_Pages_Maintenance.aspx.cs" Inherits="CMPWeb.CMS.CMS_Pages_Maintenance" %>
...
function CheckSubmit()
{
    ...
    <tr>    
    <td >
    <asp:Label id="lblOutline" Text="Outline Name" runat="server"></asp:Label>
    </td>
    <td>
    ...
    <tr>
    <td >
    <asp:Label id="lblIsPublished" Text="Published" runat="server"></asp:Label>
    </td>
    <td>
    <asp:RadioButton ID="rbYes" GroupName="grpPublished" Text="Yes" runat="server" />
    <asp:RadioButton ID="rbNo" GroupName="grpPublished" Checked="true" Text="No" runat="server" />
    </td>
    </tr>
    </table>
        <br />
