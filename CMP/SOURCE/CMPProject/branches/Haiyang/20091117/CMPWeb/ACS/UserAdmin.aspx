<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="UserAdmin.aspx.cs" Inherits="CMPWeb.ACS.UserAdmin" Title="User Admin Maintenance" %>
     ...
     <table cellpadding="0" cellspacing="0" width="100%" >
        <tr>
            <td style="width:60%" valign="top" >
                <asp:GridView Width="100%" runat="server" ID="gv_UserAdmins" AutoGenerateColumns="false" DataKeyNames="UserAdminListID" >
                <Columns>
                    <asp:TemplateField>
                        <HeaderTemplate>
                        ...
                        <itemtemplate>
                            <asp:CheckBox id="chkSelectedUserAdmin" runat="server" />  
                            <asp:HiddenField ID="hfUserAdminListID" Value='<%#Eval("UserAdminListID")%>' runat="server" />
                        </itemtemplate>
                    </asp:TemplateField>
                     
                    <asp:HyperLinkField DataNavigateUrlFields="UserAdminListID" DataNavigateUrlFormatString="~/ACS/UserAdminMaintenance.aspx?Action=Update&UserAdminID={0}"
                         DataTextField="UserAdminName" NavigateUrl="~/ACS/UserAdminMaintenance.aspx" HeaderText = "Name"/>
                    
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label runat="server" ID="lbUserAdminRemarkHeader" Text="Remark" />
                        </HeaderTemplate>
                        
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbUserAdminRemark" Text='<%#Eval("UserAdmin_Remark") %>'/>
                        </ItemTemplate>
                    </asp:TemplateField> 
