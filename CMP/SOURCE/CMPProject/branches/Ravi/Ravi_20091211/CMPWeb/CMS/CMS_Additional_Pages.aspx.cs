...
{
    public partial class CMS_Additional_Pages : System.Web.UI.Page
    {
        ...
        private void LoadPageDetails()
        {
            try
            {
                ...
                DataTable siteDT = cmsBL.GetAllAdditionalPages(hdnSiteID.Value);
        ...
        {
            Response.Redirect("../CMS/CMS_Addtnl_Page_Maintenance.aspx?type=add&siteName=" + lblSiteName.Text + "&companyName=" + lblCompanyName.Text +
                "&siteID=" + hdnSiteID.Value, false);
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (rowNumber >= 0)
            {
                ...
                CMSBL cmsBL = new CMSBL();
                returnNumber = cmsBL.DeleteAdditionalPage(hdnSiteID.Value, pageID);
            }
        ...
        public void EditOutline(object sender, System.EventArgs e)
        {
            ...
            string pageID = dgPages.Items[dgPages.SelectedIndex].Cells[0].Text;
            Response.Redirect("../CMS/CMS_Addtnl_Page_Maintenance.aspx?type=update&siteName=" + lblSiteName.Text + "&companyName=" +
                lblCompanyName.Text + "&siteID=" + hdnSiteID.Value + "&pageID=" + pageID, false);
        }
            ...
            try
            {
                ...
                if (rowNumber >= 0)
                {
                    ...
                    Response.Redirect("../CMS/HTMLEdit.aspx?PageModId=" + pageModID + "&PageName=" + pageName + "&companyName=" + lblCompanyName.Text +
                        "&siteName=" + lblSiteName.Text + "&siteID=" + hdnSiteID.Value);
                }
