<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="CMS_Additional_Pages.aspx.cs" Inherits="CMPWeb.CMS.CMS_Additional_Pages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center><h1> Additional Page Maintenance </h1></center> <br />
    ...
    <asp:Button ID="btnGoOutline" Text="GoTo Outline" runat="server" 
            onclick="btnGoOutline_Click" />
